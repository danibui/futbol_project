    ...
    <div className="container">
      ...
      <div className="actions-container" style={{ display: 'flex', justifyContent: 'flex-start', marginBottom: '1rem' }}>
        <ButtonGroup className="mb-3">
          <Button variant="light" onClick={handleEvenRows} style={{ marginRight: '0.5rem' }}>Pintar Pares</Button>
          <Button variant="light" onClick={handleOddRows} style={{ marginRight: '0.5rem' }}>Pintar Impares</Button>
          <Button variant="light" onClick={handleRows1To10} style={{ marginRight: '0.5rem' }}>Traer de 1 a 10</Button>
          <Button variant="light" onClick={handleRows11To20} style={{ marginRight: '0.5rem' }}>Traer de 11 a 20</Button>
        </ButtonGroup>
      </div>
